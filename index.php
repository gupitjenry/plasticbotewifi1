...
body { 
  ...
  background-image: radial-gradient(circle at 10px 10px, rgba(96, 165, 250, 0.15) 2px, transparent 0);
...
#bottleCountSection #bottleCount {
  font-size: 4rem;
  font-weight: 700;
  color: var(--accent);
}

#bottleCountSection #totalTime {
  color: var(--accent);
  font-size: 1.1rem;
  font-weight: 600;
  margin-top: 0.5rem;
...
@media (max-width:640px){
  .container{padding:1.5rem;margin:0.75rem;border-radius:16px;}
  .title{font-size:1.25rem;}
  .emoji{font-size:1.25rem;}
  .timer-display{font-size:2.5rem;}
  .start-button{padding:0.875rem 1.25rem;font-size:0.9375rem;}
  .status-grid{gap:0.75rem;}
  .status-card{padding:0.625rem;}
}
</style>
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1 class="title">Plastic Bottle WiFi</h1>
            <p class="subtitle">Insert Bottles to Earn WiFi</p>
            <div class="info-pill">
                <span>1 Bottle = 5 minutes</span>
            </div>
        </div>

        <div id="bottleCountSection">
            <div id="bottleCount">0</div>
            <p class="subtitle">Bottles Collected</p>
            <p id="totalTime">0 minutes WiFi</p>
        </div>
        ...
        <div id="startSection">
            <button id="startButton" class="start-button pulse">
                <span>Recycling your Bottle</span>
            </button>
        ...
        <div id="collectingSection" style="display: none;">
            <button id="addBottleButton" class="start-button" style="margin-bottom: 1rem;">
                <span>Insert Bottles Again</span>
            </button>
            <button id="doneButton" class="start-button" style="background: linear-gradient(90deg, var(--accent), #1d4ed8);">
                <span>Get WiFi</span>
        ...
        <div id="successMessage" class="success-message">
            ...
            <p class="subtitle" id="wifiGrantedSubtitle">Thank you for recycling. Your WiFi access starts now.</p>
            ...
            <div class="network-info">Network: PLASTIC_BOTTLE_WiFi</div>
        </div>
